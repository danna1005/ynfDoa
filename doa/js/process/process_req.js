...
//	var u = "km/review/km_review_index/kmReviewIndex.do?method=list&q.mydoc=create&orderby=docCreateTime&ordertype=down";
	var u = "sys/lbpmmonitor/sys_lbpmmonitor_person/SysLbpmMonitorPerson.do?method=listChildren&q.myDoc=create&orderby=fdCreateTime&ordertype=down&s_ajax=true";
	        			...
	        			<div class="item-content">\
							<div class="item-inner">\
					          <div class="item-title">\
					          	<span class="tit">\
					          		<span class="type '+cls+' stateCode-'+stateCode+'">'+r.flowState+'</span>\
