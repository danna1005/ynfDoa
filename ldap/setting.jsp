...
function _close(){
	...
	<div id="optBarDiv">
		...
		<input type="button" class="btnopt" value="样本采集" onclick="_showSample();"/>
		<input type="button" class="btnopt" value="删除同步时间戳" onclick="_delTimeStamp();" title="删除时间戳后，下次同步会执行全量同步，请谨慎操作！"/>
