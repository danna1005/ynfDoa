...
<%--<div id="optBarDiv">
	<kmss:auth requestURL="/third/ywork/ywork_doc_read/yworkDocRead.do?method=edit&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.edit"/>"
			onclick="Com_OpenWindow('yworkDocRead.do?method=edit&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<kmss:auth requestURL="/third/ywork/ywork_doc_read/yworkDocRead.do?method=delete&fdId=${param.fdId}" requestMethod="GET">
		<input type="button"
			value="<bean:message key="button.delete"/>"
			onclick="if(!confirmDelete())return;Com_OpenWindow('yworkDocRead.do?method=delete&fdId=${param.fdId}','_self');">
	</kmss:auth>
	<input type="button"
 ...
 --%>
<p class="txttitle"><bean:message bundle="third-ywork" key="table.yworkDocRead"/></p>

<center>
<table class="tb_normal" width=95%>
	<tr>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="third-ywork" key="yworkDocRead.fdName"/>
		</td><td width="35%">
	...
	<tr>
		<td class="td_normal_title" width=15%>
			<bean:message bundle="third-ywork" key="yworkDocRead.fdHead"/>
		</td><td width="35%">
	...
	<tr>
		...
		<td class="td_normal_title" width=15%>
			...
			<c:out value="${yworkDocReadForm.fdDocName}" />
		</td>
	</tr>
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<c:out value="${yworkDocReadForm.fdUserName}" />
		</td>
