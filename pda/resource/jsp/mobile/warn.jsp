...
<template:include file="/third/pda/template.jsp" compatibleMode="true">
	...
	<template:replace name="content">
			<div class="noPowerTipWrapper noPdaBrowse gray">
		        ...
		        <p class="tips"><%=ResourceUtil.getOfficialString("third-pda:global.pda.visit") %></p>
		        <a class="btnReturn" onclick="redirectTo()"><i class="mui mui-back"></i><%=ResourceUtil.getOfficialString("third-pda:phone.view.back")%></a>
	    	</div>
