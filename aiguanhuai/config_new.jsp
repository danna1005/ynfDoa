...
<body>
                            ...
                            <table class="table t-left">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="input-wrap">
                                            <input type="text" disabled class="form-ipt" name="corp_id" value="<%=uniqueFlag %>" placeholder="由爱关怀提供，用于识别您的身份" required>
                                        </td>
                                        <td class="ipt-r">*</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="input-wrap">
                                            <input type="text" disabled class="form-ipt" name="corp_key" value="<%=encryptKey %>" placeholder="不用在意那串复杂的字符，复制粘贴就好了" required>
                                        </td>
                                        <td class="ipt-r">*</td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table t-left">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="input-wrap">
                                            <input type="text" id="password" class="form-ipt" name="backlog_PWD" value="" placeholder="格式不限，当然要输入你喜欢的" <% if(password==""){ %>required<% } %>>
                                        </td>
                                        <td class="ipt-r"><% if(password==""){ %>*<% } %></td>
                                    </tr>
    ...
    <script>
        ...
        function saveProPerties(){
            ...
            var url = '<c:url value="/third/aiguanhuai/control.jsp?method=saveProPerties"/>'+'&userName='+userName+'&password='+password;
            $.ajax(
        	{
        		url : url,
        		dataType : 'json',
